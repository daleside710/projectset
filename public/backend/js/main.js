...
!(function (i) {
  ...
  feather.replace(),
    i(document).on("click", '[data-toggle="fullscreen"]', function () {
      return (
        i(this).toggleClass("active-fullscreen"),
        document.fullscreenEnabled
          ? i(this).hasClass("active-fullscreen")
    ...
    i(document).on("click", ".navigation-toggler > a", function () {
      return (
        a.hasClass("small-navigation")
          ? (a.removeClass("small-navigation"),
          ...
          : a.hasClass("hidden-navigation") || n.width() < 1200
            ? (i.createOverlay(),
              ...
              i('[data-toggle="dropdown"]').dropdown("hide"))
            : (a.addClass("small-navigation"),
              i(".navigation")
                .getNiceScroll()
                .remove(),
              i(".navigation .navigation-menu-body > ul > li").each(function () {
    ...
    (i.createOverlay = function () {
      i(".overlay").length < 1 &&
        (a.addClass("no-scroll").append('<div class="overlay"></div>'),
          i(".overlay").addClass("show"));
    }),
    (i.removeOverlay = function () {
      a.removeClass("no-scroll"), i(".overlay").remove();
    }),
    ...
    n.on("load", function () {
      setTimeout(function () {
        i(".navigation .navigation-menu-body ul li a").each(function () {
          var e = i(this);
          e.next("ul").length &&
            e.append('<i class="sub-menu-arrow ti-angle-up"></i>');
        }),
          i(".navigation .navigation-menu-body ul li.open>a>.sub-menu-arrow")
            .removeClass("ti-plus")
            .addClass("ti-minus")
            .addClass("rotate-in");
      }, 200);
  ...
  e.find("th").each(function (e) {
    i(".table-responsive-stack td:nth-child(" + (e + 1) + ")").prepend(
  ...
  if ((s.on("show.bs.dropdown", function (e) {
    (o = i(e.target).find(".dropdown-menu")), a.append(o.detach());
    ...
    s.on("hide.bs.dropdown", function (e) {
      i(e.target).append(o.detach()), o.hide();
    }),
    i(document).on(
      "click",
      ...
      function () {
        return (
          i(".chat-app-wrapper .chat-sidebar").addClass("chat-sidebar-opened"),
          !1
        );
      }
    ),
    i(document).on("click", "*", function (e) {
      i(e.target).is(
        ...
        i(".chat-app-wrapper .chat-sidebar").removeClass("chat-sidebar-opened");
    }),
      ...
      if (e.next("ul").length) {
        ...
        return (
          ...
          e
            ...
            .find(".sub-menu-arrow")
            .removeClass("rotate-in"),
          t.hasClass("rotate-in")
            ? setTimeout(function () {
              t.removeClass("ti-plus").addClass("ti-minus");
            }, 200)
            : t.removeClass("ti-minus").addClass("ti-plus"),
          !a.hasClass("horizontal-side-menu") &&
          1200 <= n.width() &&
    ...
    i("body.icon-side-menu .navigation").hover(
      function (e) { },
      function (e) {
        e.stopPropagation(),
    ...
    i(".card-scroll").niceScroll(),
      ...
      i(
        ".chat-block .chat-sidebar .chat-sidebar-content .tab-content .tab-pane"
      ).niceScroll();
  ...
  !a.hasClass("small-navigation") &&
    ...
    i(document).on(
      ...
      function () {
        return i(".chat-block .chat-content").removeClass("mobile-open"), !1;
      }
    );
})(jQuery);
