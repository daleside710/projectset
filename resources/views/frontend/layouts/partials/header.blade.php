                ...
                <ul class="nav-account">
                    ...
                    <li class="nav-account__item main-nav__sub-title">
                        ...
                        <ul class="main-nav__sub">
                            ...
                            <li><a href="{{ route('admin.coupons.index') }}">Kupongoversikt</a></li>
                            <li><a href="{{ route('admin.newsletter.index') }}">Send nyhetsbrev</a></li>
                            <li><a href="{{ route('admin.mail.index') }}">Mottatte e-poster</a></li>
                            <li><a href="{{ route('admin.faqs.edit') }}">Endre ofte stilte spørsmål</a></li>
                            <li>
                                <form action="{{ route('logout') }}" method="post">
                                    <input type="hidden" name="_token" value="{{ Session::token() }}">
                                    <button class="nav-account__item--logout">Logg ut</button>
                    ...
                    <li class="nav-account__item main-nav__sub-title">
                        ...
                        <ul class="main-nav__sub">
                            ...
                            <li><a href="{{ route('deposit') }}">Gjør et innskudd</a></li>
                            <li><a href="{{ route('admin.sms.create') }}">Send SMS</a></li>
                            <li>
                                <form action="{{ route('logout') }}" method="post">
                                    <input type="hidden" name="_token" value="{{ Session::token() }}">
                                    <button class="nav-account__item--logout">Logg ut</button>
                    ...
                    <li class="nav-account__item"><a href="/#registerModal">Opprett en konto</a></li>
