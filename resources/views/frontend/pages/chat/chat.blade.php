...
@push('style')
    <style>
        ...
        .msg_send_btn {
            background: #cafa5a none repeat scroll 0 0;
            border: medium none;
            border-radius: 50%;
            color: #1e202e;
            cursor: pointer;
...
@section('content')
    ...
    <div class="container" id="app">
        <h3 class=" text-center">Henvendelser</h3>
                            ...
                            <div class="status_box">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="changeStatus('{{$querie->id}}','pending')" id="pending" style="display: {{$querie->status == 'pending' ? 'none':'block'}};">Avventer svar</a>
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="changeStatus('{{$querie->id}}','active')" id="active" style="display: {{$querie->status == 'active' ? 'none':'block'}};">Aktiv</a>
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="changeStatus('{{$querie->id}}','closed')" id="closed" style="display: {{$querie->status == 'closed' ? 'none':'block'}};">Lukket</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="type_msg">
                        <div class="input_msg_write">
                            <form name="messageForm" id="messageForm">
                                ...
                                <input type="text" name="message" id="messageText" class="write_msg" placeholder="Skriv en melding..." />
                            </form>
    ...
    <meta name="sendMessage" content="{{route('Message_chat')}}">
    <meta name="fetchMessages" content="{{route('fetchMessages')}}">
...
@push('script')
    ...
    <script>
        ...
        function adminMessage(data){
            ...
            if(EventData.type == 'admin' && EventData.receiver_id == loggedInUser.id && EventData.chat_id == chat_id)
            {
                var d = new Date();
                var now = d.getFullYear() + "-" + (d.getMonth()+1) + "-" + d.getDate()+' '+d.getHours() + ":" + (d.getMinutes()) + ":" + d.getSeconds();
