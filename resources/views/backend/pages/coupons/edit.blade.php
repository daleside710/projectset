                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control" type="text" value="{{ $couponCode->code }}" name="code" id="code" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="validationCustom02">Velg type</label>
                                <select name="type" id="type" class="form-control" required>
                                    <option value="">Velg type</option>
                                    <option @if($couponCode->type == "discountedspin") selected @endif value="discountedspin">1. Rabattert spin
                                    </option>
                                    <option @if($couponCode->type == "deposit") selected @endif value="deposit">2. Beløp innskudd
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="validationCustom03">Antall bruk per brukerkonto</label>
                                <input class="form-control" type="number" min="1" value="{{ $couponCode->no_of_use }}" name="no_of_use" id="no_of_use" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                <label for="validationCustom04">Beløp</label>
                                <input class="form-control" type="number" min="0.00" step="0.01" value="{{ $couponCode->amount }}" name="amount" id="amount">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="box_id" id="box_id" class="form-control">
                                    ...
                                    @foreach($boxes as $box)
                                        <option @if(!is_null($couponCode->box_id)) @if($couponCode->box_id == $box->id) selected @endif @endif value="{{ $box->id }}">{{ $box->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="user_id" id="user_id" class="form-control">
                                    ...
                                    @foreach($users as $user)
                                        <option @if(!is_null($couponCode->user_id)) @if($couponCode->user_id == $user->id) selected @endif @endif value="{{ $user->id }}">{{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control" type="date" name="valid_from" value="{{ $couponCode->valid_from }}" id="valid_from" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="validationCustom08">Gyldig til</label>
                                <input class="form-control" type="date" name="valid_to" value="{{ $couponCode->valid_to }}" id="valid_to" required>
                            </div>
                        </div>
