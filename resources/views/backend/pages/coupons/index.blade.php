                    ...
                    <div class="card-body">
                        <h6 class="card-title d-md-flex justify-content-between">
                            ...
                            <a href="{{ route('admin.coupons.create') }}"
                               class="btn btn-purple btn-pulse btn-sm mt-3 mt-md-0">Opprett ny kupong</a>
                        </h6>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">Bruk per konto</th>
                                    <th scope="col">Totalt brukt</th>
                                ...
                                @foreach($couponCodes as $couponCode)
                                    <tr>
                                        ...
                                        <td>{{ !is_null( $couponCode->codeusers ) ? count($couponCode->codeusers) : 0 }}</td>
                                        ...
                                        <td class="text-center text-uppercase">
                                            <a href="{{ route('admin.coupons.edit', $couponCode->id) }}"
                                               class="btn btn-sm btn-warning mr-2">Endre</a>
                                            <a href="{{ route('admin.coupons.destroy', $couponCode->id) }}"
                                               class="btn btn-sm btn-danger"
                                               onClick="event.preventDefault(); document.getElementById('delete-form-{{$couponCode->id}}').submit();">Slett</a>
                                            <form id="delete-form-{{$couponCode->id}}"
                                                  action="{{ route('admin.coupons.destroy', $couponCode->id) }}"
