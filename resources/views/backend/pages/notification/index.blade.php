...
<div class="container my-5">
    <div class="row">
        ...
        <div class="col-md-12">
            <form class="needs-validation" action="{{ route('admin.notification.send') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input name="notification_icon" type="file" class="custom-file-input" id="notification_icon" aria-describedby="inputGroupFileAddon01" required>
