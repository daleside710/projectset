...
<div class="container my-5">
    <div class="row">
        ...
        <div class="col-md-12">
            <form class="needs-validation" action="{{ route('admin.newsletter.send') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <select class="selectpicker" name="user_id[]" multiple data-live-search="true" required>
