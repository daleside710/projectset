      ...
      <div class="card">
        <div class="card-body">
          <h6 class="card-title d-md-flex justify-content-between">
            ...
            <a href="{{ route('admin.products.create') }}" class="btn btn-purple btn-pulse btn-sm mt-3 mt-md-0">Opprett nytt produkt</a>
          </h6>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center text-uppercase">
                    <a href="{{ route('admin.products.edit', $product->id) }}" class="btn btn-sm btn-warning mr-2">Endre</a>
                    <a href="{{ route('admin.products.delete', $product->id) }}" class="btn btn-sm btn-danger">Slett</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
