...
@section('content')
    <div class="container my-5">
        <div class="row">
            <div class="col-md-12">
                <form class="needs-validation" action="{{ route('admin.products.update', $product->id) }}" method="post"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input value="{{ $product->sell_back_price }}" type="text" class="form-control"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="delivery_fee"
                                           aria-describedby="basic-addon1" value="{{ $product->delivery_fee }}">
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select style="width: 100%" multiple data-tags="true"
                                                data-placeholder="Add sizes" data-allow-clear="true" name="sizes[]"
                                                id="sizes" class="form-control">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select style="width: 100%" multiple data-tags="true"
                                                data-placeholder="Add colors" data-allow-clear="true" name="colors[]"
                                                id="colors" class="form-control">
