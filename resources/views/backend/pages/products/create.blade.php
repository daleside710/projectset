            ...
            <div class="form-row">
              ...
              <div class="col-md-4 mb-3">
                  <div class="form-group">
                      ...
                      <select multiple data-tags="true" data-placeholder="Legg til størrelser" data-allow-clear="true" name="sizes[]" id="sizes" class="form-control"></select>
                  </div>
              </div>
              <div class="col-md-4 mb-3">
                  <div class="form-group">
                      <label for="">Farge</label>
                      <select multiple data-tags="true" data-placeholder="Legg til farger" data-allow-clear="true" name="colors[]" id="colors" class="form-control"></select>
                  </div>
              </div>
            </div>
