                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <figure class="avatar avatar-sm border-0 mr-2">
                                                <img class="rounded-circle"
                                                     src="{{ Storage::disk('s3')->url($order->user->image_path ?? 'images/avatars/default.png') }}">
                                            </figure>
                                        ...
                                        <td class="text-center text-uppercase">
                                            <a href="{{ route('admin.orders.view', $order->id) }}"
                                               class="btn btn-sm btn-outline-info mr-2">Detaljer</a>
                                            @if($order->status == 0)
                                                <a href="{{ route('admin.orders.sent', $order->id) }}"
                                                   class="btn btn-sm btn-info">Marker som sendt</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
