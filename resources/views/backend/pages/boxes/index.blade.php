                    ...
                    <div class="card-body">
                        <h6 class="card-title d-md-flex justify-content-between">
                            ...
                            <a href="{{ route('admin.boxes.create') }}"
                               class="btn btn-purple btn-pulse btn-sm mt-3 mt-md-0">Opprett ny boks</a>
                        </h6>
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($boxes as $box)
                                    <tr>
                                        ...
                                        <td>
                                            <figure class="avatar avatar-sm border-0 mr-2">
                                                <img class="rounded-circle"
                                                     src="{{ Storage::disk('s3')->url($box->image_path) }}"
                                                     alt="{{ $box->name }}">
                                            </figure>
                                        ...
                                        <td>{{ number_format($box->price, 0, '.', ' ') }},-</td>
                                        ...
                                        <td class="text-center text-uppercase">
                                            ...
                                            <a href="{{ route('admin.boxes.delete', $box->id) }}"
